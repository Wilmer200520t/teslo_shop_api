...
export const initialData: SeedData = {
  products: [
    ...
    {
      description:
        'Designed for comfort and style in any sizes, the Tesla Small Wordmark Tee is made from 100% Peruvian cotton and features a 3D silicone-printed wordmark on the left chest.',
    ...
    {
      description:
        'Cruise the playground in style with the Kids Corp Jacket. Modeled after the original Tesla Corp Jacket, the Kids Corp Jacket features the same understated style and high-quality materials but at a pint-sizesd scale.',
  ...
  users: [
    {
      fullName: 'Wilmer Rojas',
      email: 'wilmer.2030@hotmail.com',
      password: 'Wilmer2005!',
